...
namespace SmartNx\Repositories;
...
abstract class BaseRepository
{
    ...
    public function firstOrCreate($whereData, $newData = null)
    {
        return $this->model->firstOrCreate($whereData, $newData);
    }
    public function find($id, bool $fail = false)
    {
        if($fail) {
    ...
    public function paginate($sort, $search, $itensPage)
    {
        $result = $this->model;
        ...
        return $result->paginate($itensPage);
    }
